      ...
      <div className="about-card">
        <main className="about-content">
          <section className="about-section">
            <h2>Sobre o Jogo</h2>
            <p>
              Lines of Action (LoA) é um jogo eletrônico de tabuleiro para dois jogadores, jogado num 
              tabuleiro 8x8 com vinte e quatro peças (doze pretas e doze brancas), 
              inventado por Claude Soucie por volta de 1960.
            </p>
            <p>
              Foi pela primeira vez publicado por Sid Sacksoan em 1969 em “A Gamut of
              Games” e foi um sucesso imediato entre os aficionados deste tipo de 
              jogos.
            </p>
            <p>
              O LoA é indicado para maiores de
              dez anos e tem uma duração média de jogo de meia hora. Até ao momento 
              não foi descoberto nenhuma sequência de jogadas que garanta uma 
              probabilidade vitória de 100%.
            </p>
          </section>          
          <section className="about-section">
            <h2>Regras</h2>
            <ol className="rules-list">
              ...
              <li>
                O jogador com as peças pretas joga primeiro.
              </li>
              <li>
              ...
              <li>
                O objetivo do jogo é colocar todas as peças que possui ligadas. As ligações entre peças podem ser verticais, horizontais ou diagonais. O primeiro jogador a consegui-lo é o vencedor.
              </li>
              <li>
